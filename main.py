...
btn_video = CTkButton(master=audio, text="Descargar video", corner_radius=0, fg_color="#C70039", hover_color="#FF5733", border_width=2, command=lambda: process_link_video(entry.get()))
